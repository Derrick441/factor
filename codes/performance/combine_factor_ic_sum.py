...
class IcSum(object):
    ...
    def construct_five_table(self):
        ...
        self.table_ic_1.to_pickle(self.save_indir + 'combine_ic_1.pkl')

        self.table_ic_5 = self.data_readin_merge(5)
        self.table_ic_5.to_pickle(self.save_indir + 'combine_ic_5.pkl')

        self.table_ic_10 = self.data_readin_merge(10)
        self.table_ic_10.to_pickle(self.save_indir + 'combine_ic_10.pkl')

        self.table_ic_20 = self.data_readin_merge(20)
        self.table_ic_20.to_pickle(self.save_indir + 'combine_ic_20.pkl')

        self.table_ic_60 = self.data_readin_merge(60)
        self.table_ic_60.to_pickle(self.save_indir + 'combine_ic_60.pkl')
    ...
    def construct_three_table(self):
        ...
        self.table_ic_2017.to_csv(self.save_indir + 'combine_ic_2017.csv')

        self.table_ic_2012 = self.data_select_merge(20120101, 20200101)
        self.table_ic_2012.to_csv(self.save_indir + 'combine_ic_2012.csv')

        self.table_ic_2005 = self.data_select_merge(20050101, 20200101)
        self.table_ic_2005.to_csv(self.save_indir + 'combine_ic_2005.csv')
