...
class TradeWeightPre(object):
    ...
    def __init__(self, file_indir, zz500_indir, factor_indir, save_indir, file_name, zz500_name, set1):
        ...
        self.factor_name = set1[0]
        self.num = set1[1]
        self.weight_name = set1[2]
...
if __name__ == '__main__':
    ...
    twp = TradeWeightPre(file_indir, zz500_indir, factor_indir, save_indir, file_name, zz500_name, set1)
    twp.runflow()
