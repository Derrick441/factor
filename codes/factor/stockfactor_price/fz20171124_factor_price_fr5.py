...
class FactorFR(object):
    ...
    def method(self, data, perid):
        ...
        return pd.DataFrame({'trade_dt': temp.trade_dt, 'fr5': factor.values})
    ...
    def fileout(self):
        ...
        item = ['trade_dt', 's_info_windcode', 'fr5']
        self.result[item].to_pickle(self.save_indir + 'factor_price_fr5.pkl')
