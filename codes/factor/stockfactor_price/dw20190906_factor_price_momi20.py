...
class Factormomi20(object):
    ...
    def compute(self):
        ...
        self.temp_result['momi20'] = self.temp_result['t5'] - self.temp_result['t1']
        print('compute running time:%10.4fs' % (time.time() - t))

    def fileout(self):
        t = time.time()
        self.result = pd.merge(self.all_data[['trade_dt', 's_info_windcode']], self.temp_result, how='left')
        item = ['trade_dt', 's_info_windcode', 'momi20']
        self.result[item].to_pickle(self.save_indir + 'factor_price_momi20.pkl')
...
if __name__ == '__main__':
    ...
    momi20 = Factormomi20(file_indir, save_indir, file_name)
    momi20.runflow()
