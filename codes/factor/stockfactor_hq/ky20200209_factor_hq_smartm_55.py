...
# 因子：聪明钱因子基于5分钟数据,5天
class FactorSmartMoney55(object):
    ...
    def method(self, data, perid):
        ...
        if num >= perid:
            ...
            return pd.DataFrame({'trade_dt': date,
                                 'smartm55': [None for i in range(num)]})
    ...
    def fileout(self):
        t = time.time()
        item1 = ['trade_dt', 's_info_windcode', 'smartm55']
        self.result[item1].to_pickle(self.save_indir + 'factor_hq_smartm55_' + self.file_name[17:21] + '.pkl')
...
if __name__ == '__main__':
    ...
    for file_name in file_names:
        fsm5 = FactorSmartMoney55(file_indir, save_indir, file_name)
        fsm5.runflow()
