...
class trade_module_adj(object):
    ...
    def tradeflow(self):
        ...
        self.tradeinfo = pd.DataFrame(data=None,index=datelist,columns=['cash','stockvalue','sellmoney','buymoney','total','stocknum'])  # 交易信息
...
#
# tradem = trade_module_position_align(closep,openp,vol,weight,enddate,initmoney,costsell,costbuy)
# tradem.tradeflow()
