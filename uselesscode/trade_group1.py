...
if __name__ == '__main__':
    ...
    for factor_name in factor_names:
        print(factor_name)
        g10 = GroupTen(file_indir, factor_indir, save_indir, file_names, factor_name, 2)
        g10.runflow()
        factor.append(g10.factor_name)
    ...
    for factor_name in factor_names:
        print(factor_name)
        g10 = GroupTen(file_indir, factor_indir, save_indir, file_names, factor_name, 3)
        g10.runflow()
        factor.append(g10.factor_name)
    ...
    for factor_name in factor_names:
        print(factor_name)
        g10 = GroupTen(file_indir, factor_indir, save_indir, file_names, factor_name, 4)
        g10.runflow()
        factor.append(g10.factor_name)
    ...
    for factor_name in factor_names:
        print(factor_name)
        g10 = GroupTen(file_indir, factor_indir, save_indir, file_names, factor_name, 5)
        g10.runflow()
        factor.append(g10.factor_name)
