...
if __name__ == '__main__':
    ...
    file_dir1 = r'C:\Users\Administrator\Desktop\LPPL模型\数据资料\上证120min均线.xls'  # 数据地址
    max_a = 8000  # 结果筛选设定

    # 变动设定 t1
    t1 = '20200323'  # 全部数据起始时间
    t2 = '20200710'  # 全部数据结束时间
    mode = 't1'  # 遍历模式（t1:起始时间遍历，t2:结束时间遍历）
    bl = 1  # 遍历间隔天数
    file_dir2 = 'C:\\Users\\Administrator\\Desktop\\result_szzs_' + mode + '.xls'  # 结果保存地址
    file_dir3 = 'C:\\Users\\Administrator\\Desktop\\mses1_szzs_' + mode + '.xls'
...
# t1 = '20200323'
# t2 = '20200710'
# file_dir1 = r'C:\Users\Administrator\Desktop\LPPL模型\数据资料\上证120min均线.xls'
# file_dir2 = 'C:\\Users\\Administrator\\Desktop\\result_szzs_t1.xls'
#
# # 数据读入
# ydata, n, tdata = data_in(t1, t2, file_dir1)
# result = pd.read_excel(file_dir2)
# result['breakday_predict_'] = result['breakday_predict'] / 2
#
# # 结果查看
# result.breakday_predict_.plot()
# result.breakday_predict_.hist()
# coef = result.iloc[90, :]
#
# # 实际和预测值
